...
STATISTICS_BURST_ENABLED="${STATISTICS_BURST_ENABLED:-false}"
...
STATISTICS_BURST_VUS="${STATISTICS_BURST_VUS:-60}"
STATISTICS_BURST_MAX_VUS="${STATISTICS_BURST_MAX_VUS:-120}"
...
echo "- statisticsBurstEnabled: $STATISTICS_BURST_ENABLED"
...
STATISTICS_BURST_ENABLED="$STATISTICS_BURST_ENABLED" \
STATISTICS_PRE_RATE="$STATISTICS_PRE_RATE" \
STATISTICS_BURST_RATE="$STATISTICS_BURST_RATE" \
STATISTICS_POST_RATE="$STATISTICS_POST_RATE" \
STATISTICS_PRE_DURATION="$STATISTICS_PRE_DURATION" \
STATISTICS_BURST_DURATION="$STATISTICS_BURST_DURATION" \
STATISTICS_POST_DURATION="$STATISTICS_POST_DURATION" \
...
STATISTICS_BURST_VUS="$STATISTICS_BURST_VUS" \
STATISTICS_BURST_MAX_VUS="$STATISTICS_BURST_MAX_VUS" \
