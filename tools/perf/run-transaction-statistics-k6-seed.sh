...
javac -cp "$CP" -d "$BUILD_DIR" "$ROOT_DIR/tools/perf/TransactionStatisticsK6Seed.java"
java -cp "$CP" TransactionStatisticsK6Seed

echo "auth env: $ROOT_DIR/build/perf/k6/transaction-statistics-auth.env"
