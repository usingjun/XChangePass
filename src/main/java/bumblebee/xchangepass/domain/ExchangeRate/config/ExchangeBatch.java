...
//            List<ExchangeRateResponse> exchangeDTOList = exchangeUtils.getExchangeDataAsDtoList();
//
//            for (ExchangeRateResponse exchangeDto : exchangeDTOList) {
//                log.info("통화 : " + exchangeDto.baseCurrency());
//                log.info("환율 : " + exchangeDto.conversionRates());
